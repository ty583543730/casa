...
class OssClient
{
     ...
     * @throws OssException
     */
    public function __construct($isCName = false, $securityToken = NULL)
    {
        $accessKeyId = trim(OssConfig::OSS_ACCESS_ID);
        $accessKeySecret = trim(OssConfig::OSS_ACCESS_KEY);
        $endpoint = trim(trim(OssConfig::OSS_ENDPOINT), "/");
        ...
        $this->bucket = OssConfig::OSS_FILE_BUCKET;
