<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"templates/admin/usersscore\index.html";i:1533201218;s:45:"E:\casa\public\templates\admin\base\base.html";i:1533172220;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['laydate', 'table'], function () {
        ...
        table.render({
            elem: '#userTable',
            url: SK.U('admin/Usersscore/index'),
            id: 'tables',
            unresize: true,
            limit: 20,
