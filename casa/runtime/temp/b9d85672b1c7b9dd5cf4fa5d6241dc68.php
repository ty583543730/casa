<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"templates/admin/release\index.html";i:1533609385;s:45:"E:\casa\public\templates\admin\base\base.html";i:1533609385;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header"><span>锁仓币释放</span>
        </div>
    ...
    layui.use(['laydate', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[ //标题栏
                ...
                {field: 'ownNum', title: '持币量', align: 'center', templet: function (d) {
                        return '<span title=" ' + d.ownNum + '">' + d.ownNum + '</span>';
                    }},
                {field: 'baseRatio', title: '算力基数', align: 'center',width:200, templet: function (d) {
                        return '<span title=" ' + d.baseRatio + '">' + d.baseRatio + '</span>';
                    }},
                {field: 'turnover', title: '交易所交易额', align: 'center', templet: function (d) {
                        return '<span title=" ' + d.turnover + '">' + d.turnover + '</span>';
                    }},
                {field: 'addRatio', title: '算力增加系数', align: 'center', templet: function (d) {
                        return '<span title=" ' + d.addRatio + '">' + d.addRatio + '</span>';
                    }},
                {field: 'num', title: '释放锁仓币数量', align: 'center', templet: function (d) {
